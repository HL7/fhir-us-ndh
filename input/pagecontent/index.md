...
- National Directory API artifacts - constrains the Base artifacts and defines a FHIR API for exchanging national directory information with a local directory.
