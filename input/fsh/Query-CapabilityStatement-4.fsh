...
Usage: #definition
Title: "Workflow Directory Server Health And Human Service Expanded Query Capability Statement"
...
* id = "wds-health-and-human-service-expanded-query-server"
* url = "http://hl7.org/fhir/us/ndh/CapabilityStatement/wds-health-and-human-service-expanded-query-server"
* name = "WdsHealthAndHumanServiceExpandedQueryCapabilityStatement"
* text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"></div>"
* text.status = #generated
* insert CapabilityCommon
* rest[+]
  * mode = #server
  * documentation = "Workflow Directory Health And Human Service Expanded Query Server"
  * resource[+]
...
//======================================================
  * resource[+]
    ...
    * type = #CareTeam
    * insert SupportedProfile(NdhCareTeam, #SHOULD)
    ...
    * insert SearchParam("category", CareTeam-category, #token, #SHOULD,"Type of team")
    //* insert SearchParam("identifier", CareTeam-identifier, #token, #SHOULD,"External Ids for this team")
