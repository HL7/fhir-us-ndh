...
//======================================================
  * resource[+]
    ...
    * extension[=].valueCanonical = "http://example.org/topic/endpoint-create-or-delete"
    * extension[+].url = "http://hl7.org/fhir/uv/subscriptions-backport/StructureDefinition/capabilitystatement-subscriptiontopic-canonical"
    * extension[=].valueCanonical = "http://example.org/topic/healthcareservice-create-or-delete"
    * extension[+].url = "http://hl7.org/fhir/uv/subscriptions-backport/StructureDefinition/capabilitystatement-subscriptiontopic-canonical"
    * extension[=].valueCanonical = "http://example.org/topic/insuranceplan-create-or-delete"
    * extension[+].url = "http://hl7.org/fhir/uv/subscriptions-backport/StructureDefinition/capabilitystatement-subscriptiontopic-canonical"
    * extension[=].valueCanonical = "http://example.org/topic/location-create-or-delete"
    * extension[+].url = "http://hl7.org/fhir/uv/subscriptions-backport/StructureDefinition/capabilitystatement-subscriptiontopic-canonical"
    * extension[=].valueCanonical = "http://example.org/topic/network-create-or-delete"
    * extension[+].url = "http://hl7.org/fhir/uv/subscriptions-backport/StructureDefinition/capabilitystatement-subscriptiontopic-canonical"
    * extension[=].valueCanonical = "http://example.org/topic/practitioner-create-or-delete"
    * extension[+].url = "http://hl7.org/fhir/uv/subscriptions-backport/StructureDefinition/capabilitystatement-subscriptiontopic-canonical"
    * extension[=].valueCanonical = "http://example.org/topic/organization-create-or-delete"
    * extension[+].url = "http://hl7.org/fhir/uv/subscriptions-backport/StructureDefinition/capabilitystatement-subscriptiontopic-canonical"
    * extension[=].valueCanonical = "http://example.org/topic/practitioner-qualification-create-modified-or-delete"
    * extension[+].url = "http://hl7.org/fhir/uv/subscriptions-backport/StructureDefinition/capabilitystatement-subscriptiontopic-canonical"
    * extension[=].valueCanonical = "http://example.org/topic/organization-qualification-create-modified-or-delete"
