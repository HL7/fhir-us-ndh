...
* rest[+]
  ...
  * insert Operation(status, http://hl7.org/fhir/uv/subscriptions-backport/OperationDefinition/backport-subscription-status, #SHOULD)
...
//======================================================
  * resource[+]
    ...
    * insert SearchParamNdh("verification-status", organizationaffiliation-verification-status, #token, #SHOULD, "Verification status")
...
//======================================================
  * resource[+]
    //* extension[$conf].valueCode = #SHALL
    * type = #Subscription
    * insert SupportedProfile(http://hl7.org/fhir/uv/subscriptions-backport/StructureDefinition/backport-subscription, #SHOULD)
    ...
    * extension[=].valueCanonical = "http://example.org/endpoint-create-or-delete"
    * extension[+].url = "http://hl7.org/fhir/uv/subscriptions-backport/StructureDefinition/capabilitystatement-subscriptiontopic-canonical"
    * extension[=].valueCanonical = "http://example.org/healthcareservice-create-or-delete"
    * extension[+].url = "http://hl7.org/fhir/uv/subscriptions-backport/StructureDefinition/capabilitystatement-subscriptiontopic-canonical"
    * extension[=].valueCanonical = "http://example.org/insuranceplan-create-or-delete"
    * extension[+].url = "http://hl7.org/fhir/uv/subscriptions-backport/StructureDefinition/capabilitystatement-subscriptiontopic-canonical"
    * extension[=].valueCanonical = "http://example.org/location-create-or-delete"
    * extension[+].url = "http://hl7.org/fhir/uv/subscriptions-backport/StructureDefinition/capabilitystatement-subscriptiontopic-canonical"
    * extension[=].valueCanonical = "http://example.org/network-create-or-delete"
    * extension[+].url = "http://hl7.org/fhir/uv/subscriptions-backport/StructureDefinition/capabilitystatement-subscriptiontopic-canonical"
    * extension[=].valueCanonical = "http://example.org/practitioner-create-or-delete"
    * extension[+].url = "http://hl7.org/fhir/uv/subscriptions-backport/StructureDefinition/capabilitystatement-subscriptiontopic-canonical"
    * extension[=].valueCanonical = "http://example.org/organization-create-or-delete"
    * extension[+].url = "http://hl7.org/fhir/uv/subscriptions-backport/StructureDefinition/capabilitystatement-subscriptiontopic-canonical"
    * extension[=].valueCanonical = "http://example.org/practitioner-qualification-create-modified-or-delete"
    * extension[+].url = "http://hl7.org/fhir/uv/subscriptions-backport/StructureDefinition/capabilitystatement-subscriptiontopic-canonical"
    * extension[=].valueCanonical = "http://example.org/organization-qualification-create-modified-or-delete"
    * insert Interaction(#read, #SHOULD, "Read Topic")
