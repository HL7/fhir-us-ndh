...
Instance: capabilityWdsEndpointBasicExpandedQueryServer
InstanceOf: CapabilityStatement
Usage: #definition
Title: "Workflow Directory Server Endpoint Basic Expanded Query Capability Statement"
...
* id = "wds-endpoint-basic-expanded-query-server"
* url = "http://hl7.org/fhir/us/ndh/CapabilityStatement/wds-endpoint-basic-expanded-query-server"
* name = "WdsEndpointBasicExpandedQueryCapabilityStatement"
* text.div = "<div xmlns=\"http://www.w3.org/1999/xhtml\"></div>"
* text.status = #generated
* insert CapabilityCommon
* rest[+]
  * mode = #server
  * documentation = "Workflow Directory Endpoint Basic Expanded Query Server"
  * resource[+]
