...
//======================================================
  * resource[+]
    ...
    * insert SearchInclude("Practitioner:practitioner-endpoint", #MAY)
    * insert SearchInclude("Practitioner:practitioner-identifier-assigner", #MAY)
    * insert SearchInclude("Practitioner:practitioner-qualification-issuer", #MAY)
    * insert SearchInclude("Practitioner:practitione-via-intermediary", #MAY)
    ...
    * insert SearchRevInclude("PractitionerRole:practitioner", #MAY)
    ...
    //* insert SearchParamNdh("practitioner-endpoint", practitioner-endpoint, #reference, #MAY, "Practitioner endpoint")
    //* insert SearchParamNdh("practitioner-identifier-assigner", practitioner-identifier-assigner, #reference, #MAY, "Practitioner identifier assigner")
    * insert SearchParamNdh("practitioner-qualification-issuer", practitioner-qualification-issuer, #reference, #MAY, "Practitioner qualification issuer")
    * insert SearchParamNdh("practitioner-qualification-code", practitioner-qualification-code, #token, #MAY, "Practitioner qualification code")
    //* insert SearchParamNdh("practitioner-qualification-period", practitioner-qualification-period, #date, #MAY, "Practitioner qualification period")
    //* insert SearchParamNdh("practitioner-qualification-wherevalid-code", practitioner-qualification-wherevalid-code, #token, #MAY, "Practitioner qualification wherevalid code")
    //* insert SearchParamNdh("practitioner-via-intermediary", practitioner-via-intermediary, #reference, #MAY, "Practitioner via intermediary")
