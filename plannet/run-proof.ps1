...
$maps = @(
    ...
    @{ Name = "Network"; ExampleDir = "Network"; MapFile = "PlanNetToNdhNetworkSM.fml"; MapCanonical = "http://hl7.org/fhir/us/ndh/StructureMap/PlanNetToNdhNetworkSM"; TargetProfile = "http://hl7.org/fhir/us/ndh/StructureDefinition/ndh-Network" },
